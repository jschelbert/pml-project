...
```
We will use the about 75% of the training set for our training (`training_train`) and the remaining 25% for measuring the performance (using `training_test`).
...
Both C5.0 as well as random forrests perform very good and deliver an accuracy of over 99%.
